...
const TABS = [
  ...
  { href: "/dashboard/garde-manger", label: "Garde-manger", icon: ShoppingBasket },
        ...
        <header className="sticky top-0 z-30 bg-paper/90 backdrop-blur border-b border-ink/10">
          <div className="max-w-5xl mx-auto px-5 sm:px-8 h-16 flex items-center justify-between">
            ...
            <div className="relative">
              ...
              >
                <span className="w-7 h-7 rounded-full bg-palm text-paper flex items-center justify-center text-xs font-bold">
                  {initiale}
                </span>
                <ChevronDown
                  size={15}
